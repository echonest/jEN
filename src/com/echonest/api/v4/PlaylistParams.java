...
public class PlaylistParams extends Params {
    public enum PlaylistType {ARTIST, ARTIST_RADIO, ARTIST_DESCRIPTION, SONG_RADIO, CATALOG, CATALOG_RADIO  }
    ...
    /**
     * Sets the desired adventurousness for the playlist.  A value between 0 and 1. A higher
     * value indicates that a more adventurous playlist should be generated.
