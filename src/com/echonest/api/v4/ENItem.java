...
public class ENItem {
    ...
    /**
     * Returns a string at the given path within the item. Paths are of the form:
     *    'key', or 'key[0]', or 'key1.key2[0].key3'
     * @param path the path
    ...
    @SuppressWarnings("unchecked")
    public Map getItemMap(String id) throws EchoNestException {
    ...
    @SuppressWarnings("unchecked")
    public Map getItemMapByName(String name, String bucket)
            throws EchoNestException {
        return getItemMap(name, bucket, "name");
    }

    @SuppressWarnings("unchecked")
    public Map getItemMap(String id, String bucket, String idType)
            throws EchoNestException {
        Params p = new Params();
        p.add(idType, id);
