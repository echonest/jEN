...
public class ArtistTest {
    ...
    private final static long THIS_YEAR = 2013L;
    ...
    public static void setUpClass() throws EchoNestException {
        en = new EchoNestAPI();
        weezer = en.newArtistByName("Weezer");
    ...
    public void testGetID() {
        System.out.println("getID " + weezer.getID());
        assertTrue(weezer.getID().equals(WEEZER_ID));
    }
    ...
    public void testGetName() throws Exception {
        ...
        assertTrue(weezer.getName().equals("Weezer"));
    }

    /**
     * Test of getHotttnesss method, of class Artist.
     */
    @Test
    public void testGetHotttnesss() throws Exception {
        System.out.println("getHotttnesss");
        assertTrue(weezer.getHotttnesss() > .2);
    }

    /**
     * Test of getFamiliarity method, of class Artist.
     */
    @Test
    public void testGetFamiliarity() throws Exception {
        System.out.println("getFamiliarity");
        assertTrue(weezer.getFamiliarity() > .2);
    }

    /**
     * Test of getForeignID method, of class Artist.
     */
    @Test
    public void testGetForeignID() throws Exception {
        System.out.println("getForeignID");
        assertNotNull(weezer.getForeignID("rdio-US"));
    }

    /**
     * Test of hasForeignID method, of class Artist.
     */
    @Test
    public void testHasForeignID() throws Exception {
        System.out.println("hasForeignID");
        assertTrue(weezer.hasForeignID("rdio-US"));
    }

    /**
     * Test of getArtistLocation method, of class Artist.
     */
    @Test
    public void testGetArtistLocation() throws Exception {
        System.out.println("getArtistLocation");
        assertTrue(weezer.getArtistLocation().getLocation().equals("Los Angeles, CA, US"));
    }
    ...
    public void testSongs() throws EchoNestException {
        ...
        checkSongs(beatles, beatles.getSongs(20, 25));
        checkSongs(weezer, weezer.getSongs(10, 12));
    }
    ...
    public void checkYearsActive(Artist artist) throws EchoNestException {
        ...
        if (ya.size() > 0) {
            ...
            if (range[0] != null && range[1] != null) {
                assertTrue("years active too long " + artist.getName(), range[1] - range[0] < 75);
                assertTrue("years active too short " + artist.getName(), range[1] - range[0] >= 1);
            } else if (range[1] == null) {
                assertTrue("years active too long " + artist.getName(), THIS_YEAR - range[0] < 75);
            }
        }
    ...
    public void artistTopHotttFreshness() throws EchoNestException {
        ...
        for (Artist artist : artists) {
            ...
            assertTrue("blog size " + artist.getName(), artist.getBlogs().size() > 0);
            assertTrue("blog age " + artist.getName(), getAgeInDays(artist.getBlogs().get(0)
                    .getDatePosted()) < 30);

            assertTrue("news size " + artist.getName(), artist.getNews().size() > 0);
            assertTrue("news age " + artist.getName(), getAgeInDays(artist.getNews().get(0)
                    .getDatePosted()) < 30);
        }
    }
